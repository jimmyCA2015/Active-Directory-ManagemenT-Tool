...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void button1_Click(object sender, EventArgs e)
    {
        ...
        {
            if (adlist.currentList1[i].SamAccountName == Textbox3.Text)
            {
                adlist.currentList1[i].FirstName = Textbox1.Text;
                adlist.currentList1[i].LastName = Textbox2.Text;
                adlist.currentList1[i].JobTitle = Textbox4.Text;
                adlist.currentList1[i].Street = Textbox5.Text;
                adlist.currentList1[i].City = Textbox6.Text;
                adlist.currentList1[i].PostalCode = Textbox7.Text;
                adlist.currentList1[i].TelephoneNumber = Textbox8.Text;
                adlist.currentList1[i].Mobile = Textbox9.Text;
                adlist.currentList1[i].Mail = Textbox10.Text;
            }
        }
